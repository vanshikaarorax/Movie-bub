		...
		<div className='bg-black min-h-screen text-white'>
			...
			<div className='container mx-auto px-4 py-8'>
				<div className='flex justify-center gap-3 mb-4'>
					<button
						className={`py-2 px-4 rounded ${
							activeTab === "movie" ? "bg-blue-400" : "bg-gray-800"
						} hover:bg-red-700`}
					...
					<button
						className={`py-2 px-4 rounded ${
							activeTab === "tv" ? "bg-blue-400" : "bg-gray-800"
						} hover:bg-red-700`}
					...
					<button
						className={`py-2 px-4 rounded ${
							activeTab === "person" ? "bg-blue-400" : "bg-gray-800"
						} hover:bg-red-700`}
				...
				<form className='flex gap-2 items-stretch mb-8 max-w-2xl mx-auto' onSubmit={handleSearch}>
					...
					/>
					<button className='bg-blue-400 hover:bg-blue-500 text-white p-2 rounded'>
